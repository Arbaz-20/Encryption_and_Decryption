...
class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("") && jPasswordField1.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Please provide the Login and Password");
        } else {
            String Username = jTextField1.getText();
            String passwd = jPasswordField1.getText();

            if (Username.equals("arbaz") && passwd.equals("arbaz")) {
                new MainFrame().setVisible(true);
            } else {
                JOptionPane.showMessageDialog(null, "Your Login ID/Passwd is incorrect");
                return;
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (evt.getActionCommand().equals("Clear")) {
            if (jTextField1.equals("") && jPasswordField1.equals("")) {
                JOptionPane.showMessageDialog(null, "you have not entered any thing to clear");
            } else {
                jTextField1.setText("");
